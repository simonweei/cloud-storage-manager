        ...
        <div className="modal-backdrop" role="presentation" onMouseDown={event => { if (event.currentTarget === event.target) setEditorOpen(false) }}>
          <section className="connection-modal" role="dialog" aria-modal="true" aria-labelledby="connection-title">
            ...
            <div className="connection-form">
              ...
              <label className="wide"><span>公开访问域名（可选，支持 HTTP/HTTPS）</span><input value={form.publicBaseUrl} onChange={event => setForm(current => ({ ...current, publicBaseUrl: event.target.value }))} placeholder="https://files.example.com 或 http://files.example.com" /></label>
